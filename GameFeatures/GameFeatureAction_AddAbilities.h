...
struct FAncientGameAbilityMapping
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FAncientGameAttributesMapping
{
	GENERATED_BODY()

	// Ability set to grant
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TSoftClassPtr<UAncientGameAbilityAttributeSet> AttributeSetType;
...
struct FGameFeatureAbilitiesEntry
{
	...
	UPROPERTY(EditAnywhere, Category="Abilities")
	TArray<FAncientGameAbilityMapping> GrantedAbilities;

	// List of attribute sets to grant to actors of the specified class 
	UPROPERTY(EditAnywhere, Category="Attributes")
	TArray<FAncientGameAttributesMapping> GrantedAttributes;
};
